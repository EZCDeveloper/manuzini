  ...
  <DropDownContainer active={props.isOpen}>
    ...
    <DropDownItem href="#" target="_blank" rel="noreferrer">
      ...
      <DropDownTextContainer>
        ...
        <DropDownItemDesc>If you want to talk just sendme a message and I'll get back</DropDownItemDesc>
      </DropDownTextContainer>
    </DropDownItem>
    <DropDownItem href="#" target="_blank" rel="noreferrer">
      <DropDownIcon>
      ...
      <DropDownTextContainer>
        ...
        <DropDownItemDesc>Ciudad de Corrientes, Argentina</DropDownItemDesc>
      </DropDownTextContainer>
    </DropDownItem>
  </DropDownContainer>
);
